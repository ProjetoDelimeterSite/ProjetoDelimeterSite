...
<div class="usuario-container" style="background: linear-gradient(120deg, #f4f4f4 60%, #e0ffe0 100%); min-height: 100vh;">
    <main class="usuario-main-content" style="max-width: 600px; margin: 0 auto; padding-bottom: 40px;">
        <div class="usuario-header" style="margin-bottom: 30px; background: linear-gradient(90deg, #43a047 70%, #388e3c 100%); border-radius: 14px;">
            <h1 style="font-size:2rem; color:#fff;">🥗 Minha Conta - Nutricionista</h1>
        </div>
        <form method="POST" action="/conta/atualizar">
            ...
            <button type="submit" style="background:#43a047;">Atualizar Dados</button>
        </form>
