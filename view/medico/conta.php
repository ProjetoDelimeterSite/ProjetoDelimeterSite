...
<div class="usuario-container" style="background: linear-gradient(120deg, #f4f4f4 60%, #e0f7fa 100%); min-height: 100vh;">
    <main class="usuario-main-content" style="max-width: 600px; margin: 0 auto; padding-bottom: 40px;">
        <div class="usuario-header" style="margin-bottom: 30px; background: linear-gradient(90deg, #1976d2 70%, #1565c0 100%); border-radius: 14px;">
            <h1 style="font-size:2rem; color:#fff;">👨‍⚕️ Minha Conta - Médico</h1>
        </div>
        <form method="POST" action="/conta/atualizar">
            ...
            <button type="submit" style="background:#1976d2;">Atualizar Dados</button>
        </form>
